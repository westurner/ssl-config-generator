module.exports = {
  contentSecurityPolicy: "default-src 'none'; base-uri 'none'; connect-src 'self' https://api-gateway.umami.dev https://data.tlsref.org; font-src 'self' https://code.cdn.mozilla.net; img-src 'self'; script-src 'self'; style-src 'self' https://code.cdn.mozilla.net",
