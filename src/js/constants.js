module.exports = {
  contentSecurityPolicy: "default-src 'none'; base-uri 'none'; connect-src 'self' https://api-gateway.umami.dev https://data.tlsref.org; font-src 'self' https://fonts.gstatic.com; img-src 'self'; script-src 'self'; style-src 'self' https://fonts.googleapis.com 'sha256-+OsIn6RhyCZCUkkvtHxFtP0kU3CGdGeLjDd9Fzqdl3o='",
