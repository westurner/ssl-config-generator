# generated 1970-01-01, Mozilla Guideline v5.7, IIS (PowerShell) 10.0.26100, old config, PQ: hybrid, HSTS
# https://ssl-config.mozilla.org/#server=iis&version=10.0.26100&config=old&guideline=5.7&hsts=true&ocsp=false&pq=hybrid
#
...
# ---------------------------------------------------------------------------
$DoPlan = @(
    @{ Kind = 'Registry'; Path = 'HKLM\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.0\Server'; Name = 'Enabled'; Type = 'DWord'; Value = 4294967295 },
    @{ Kind = 'Registry'; Path = 'HKLM\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.0\Server'; Name = 'DisabledByDefault'; Type = 'DWord'; Value = 0 },
    @{ Kind = 'Registry'; Path = 'HKLM\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.0\Client'; Name = 'Enabled'; Type = 'DWord'; Value = 4294967295 },
    @{ Kind = 'Registry'; Path = 'HKLM\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.0\Client'; Name = 'DisabledByDefault'; Type = 'DWord'; Value = 0 },
    @{ Kind = 'Registry'; Path = 'HKLM\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.1\Server'; Name = 'Enabled'; Type = 'DWord'; Value = 4294967295 },
    @{ Kind = 'Registry'; Path = 'HKLM\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.1\Server'; Name = 'DisabledByDefault'; Type = 'DWord'; Value = 0 },
    @{ Kind = 'Registry'; Path = 'HKLM\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.1\Client'; Name = 'Enabled'; Type = 'DWord'; Value = 4294967295 },
    @{ Kind = 'Registry'; Path = 'HKLM\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.1\Client'; Name = 'DisabledByDefault'; Type = 'DWord'; Value = 0 },
...
$DroppedCiphers = @('TLS_DHE_RSA_WITH_AES_128_GCM_SHA256', 'TLS_DHE_RSA_WITH_AES_256_GCM_SHA384', 'TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256', 'TLS_DHE_RSA_WITH_AES_128_CBC_SHA256', 'TLS_DHE_RSA_WITH_AES_256_CBC_SHA256')
...
# the Mozilla old profile, by writing
