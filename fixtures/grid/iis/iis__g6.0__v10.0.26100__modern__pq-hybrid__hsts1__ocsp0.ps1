# generated 1970-01-01, Mozilla Guideline v6.0, IIS (PowerShell) 10.0.26100, modern config, PQ: hybrid, HSTS
# https://ssl-config.mozilla.org/#server=iis&version=10.0.26100&config=modern&guideline=6.0&hsts=true&ocsp=false&pq=hybrid
#
...
#   secp384r1 -> NistP384
#
# PQ HYBRID mode: this profile includes the X25519MLKEM768
...
$DoPlan = @(
    ...
    @{ Kind = 'Registry'; Path = 'HKLM\SOFTWARE\Policies\Microsoft\Cryptography\Configuration\SSL\00010002'; Name = 'EccCurves'; Type = 'MultiString'; Value = @('MLKEM768X25519', 'curve25519', 'NistP256', 'NistP384') },
...
# the Mozilla modern profile, by writing
