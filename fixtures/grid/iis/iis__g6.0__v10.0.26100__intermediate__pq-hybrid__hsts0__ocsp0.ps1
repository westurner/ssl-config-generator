# generated 1970-01-01, Mozilla Guideline v6.0, IIS (PowerShell) 10.0.26100, intermediate config, PQ: hybrid
# https://ssl-config.mozilla.org/#server=iis&version=10.0.26100&config=intermediate&guideline=6.0&hsts=false&ocsp=false&pq=hybrid
#
