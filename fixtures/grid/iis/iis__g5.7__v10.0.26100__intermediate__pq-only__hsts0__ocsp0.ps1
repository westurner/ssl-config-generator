# generated 1970-01-01, Mozilla Guideline v5.7, IIS (PowerShell) 10.0.26100, intermediate config, PQ: only
# https://ssl-config.mozilla.org/#server=iis&version=10.0.26100&config=intermediate&guideline=5.7&hsts=false&ocsp=false&pq=only
#
