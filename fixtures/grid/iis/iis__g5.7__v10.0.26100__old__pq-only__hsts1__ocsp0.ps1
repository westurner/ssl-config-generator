# generated 1970-01-01, Mozilla Guideline v5.7, IIS (PowerShell) 10.0.26100, old config, PQ: only, HSTS
# https://ssl-config.mozilla.org/#server=iis&version=10.0.26100&config=old&guideline=5.7&hsts=true&ocsp=false&pq=only
#
...
#
# PQ ONLY mode: this profile includes the X25519MLKEM768
...
$DoPlan = @(
    ...
    @{ Kind = 'Registry'; Path = 'HKLM\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.2\Server'; Name = 'Enabled'; Type = 'DWord'; Value = 0 },
    @{ Kind = 'Registry'; Path = 'HKLM\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.2\Server'; Name = 'DisabledByDefault'; Type = 'DWord'; Value = 1 },
    @{ Kind = 'Registry'; Path = 'HKLM\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.2\Client'; Name = 'Enabled'; Type = 'DWord'; Value = 0 },
    @{ Kind = 'Registry'; Path = 'HKLM\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.2\Client'; Name = 'DisabledByDefault'; Type = 'DWord'; Value = 1 },
    ...
    @{ Kind = 'Registry'; Path = 'HKLM\SOFTWARE\Policies\Microsoft\Cryptography\Configuration\SSL\00010002'; Name = 'EccCurves'; Type = 'MultiString'; Value = @('MLKEM768X25519') },
