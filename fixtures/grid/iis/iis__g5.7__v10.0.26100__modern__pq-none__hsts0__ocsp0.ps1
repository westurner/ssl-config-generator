# generated 1970-01-01, Mozilla Guideline v5.7, IIS (PowerShell) 10.0.26100, modern config, PQ: none
# https://ssl-config.mozilla.org/#server=iis&version=10.0.26100&config=modern&guideline=5.7&hsts=false&ocsp=false&pq=none
#
