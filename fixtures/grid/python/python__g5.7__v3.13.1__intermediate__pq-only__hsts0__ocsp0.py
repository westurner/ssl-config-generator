# generated 1970-01-01, TLSRef Guideline v5.7, Python (ssl module) 3.13.1, OpenSSL 4.0.0, intermediate config, PQ: only
# https://ssl-config.mozilla.org/#server=python&version=3.13.1&config=intermediate&openssl=4.0.0&guideline=5.7&hsts=false&ocsp=false&pq=only
#
