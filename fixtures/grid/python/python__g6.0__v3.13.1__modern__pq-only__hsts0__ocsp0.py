# generated 1970-01-01, TLSRef Guideline v6.0, Python (ssl module) 3.13.1, OpenSSL 4.0.0, modern config, PQ: only
# https://ssl-config.mozilla.org/#server=python&version=3.13.1&config=modern&openssl=4.0.0&guideline=6.0&hsts=false&ocsp=false&pq=only
#
