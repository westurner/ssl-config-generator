// generated 1970-01-01, Mozilla Guideline v6.0, Go 1.23.3, modern config, PQ: hybrid
// https://ssl-config.mozilla.org/#server=go&version=1.23.3&config=modern&guideline=6.0&hsts=false&ocsp=false&pq=hybrid
package main
